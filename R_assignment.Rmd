...
qplot(data=data_s, factor(data_channel), log(shares), position="jitter", colour=data_channel)
...
qplot(data=data_s, factor(weekday), shares)
...
# H0: there are no differences in the number of shares between the days that articles are posted
# Ha: there ARE differences in the number of shares between the days that articles are posted
...
# There might be a difference in shares between weekends and weekdays? 
