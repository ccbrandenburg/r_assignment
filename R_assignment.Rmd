...
Analyses
- articles, shares, shares/article
- weekdays, channels
- regressions, plots, correlations
- validation
...
Many of the flag variables could be consolidated into one categorical variable, so we mutated them. For example, instead of a categorical variable citing which day of the week the article was published, there was a flag variable for each day of the week stating whether or not the article had been published that day. This was also the case for data_channel, which describes the topic of the article.
